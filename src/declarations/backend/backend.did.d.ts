...
export type Result = { 'Ok' : GetDelegationResponse } |
  { 'Err' : string };
export type Result_1 = { 'Ok' : null } |
  { 'Err' : string };
export type Result_2 = { 'Ok' : PrepareDelegationResponse } |
  { 'Err' : string };
...
export interface _SERVICE {
  ...
  'get_delegation' : ActorMethod<[GetDelegationRequest], Result>,
  ...
  'prepare_delegation' : ActorMethod<[PrepareDelegationRequest], Result_2>,
}
